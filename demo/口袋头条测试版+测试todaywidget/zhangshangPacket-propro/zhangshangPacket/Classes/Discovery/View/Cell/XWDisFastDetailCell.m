...
#import "XWDisFastDetailCell.h"

@implementation XWDisFastDetailCell
...
//    [self.iconImageView sd_setImageWithURL:[NSURL URLWithString:dataModel.imgsrc] placeholderImage:MyImage(@"bg_user_nouser")];
//    
