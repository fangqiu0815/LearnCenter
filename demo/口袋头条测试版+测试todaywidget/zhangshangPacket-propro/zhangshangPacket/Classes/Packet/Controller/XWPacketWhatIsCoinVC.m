...
@interface XWPacketWhatIsCoinVC ()
<UIWebViewDelegate>
{
...
@implementation XWPacketWhatIsCoinVC
...
- (void)addView
{
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@",STUserDefaults.htmlurl,@"html/aboutTask.html"];
    JLLog(@"任务规则URL：%@",url);
