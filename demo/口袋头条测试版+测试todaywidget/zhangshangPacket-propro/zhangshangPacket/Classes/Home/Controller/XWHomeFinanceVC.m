...
@implementation XWHomeFinanceVC
...
- (void)loadNewFirstDataWithParam:(NSInteger)artid
{
    ...
    [STRequest FinanceInfoNewDataParam:artid andDireParam:direDown andDataBlock:^(id ServersData, BOOL isSuccess) {
        ...
        if (isSuccess) {
            if ([ServersData[@"c"] intValue] == 1) {
                ...
                NSMutableArray *arrtemp = [NSMutableArray arrayWithArray:dictemp[@"financelist"]];
...
- (void)loadOldDataWithParam:(NSInteger)artid
{
    ...
    [STRequest FinanceInfoNewDataParam:artid andDireParam:direUP andDataBlock:^(id ServersData, BOOL isSuccess) {
        self.dataModel = [XWHomeModel mj_objectWithKeyValues:ServersData];
        if (isSuccess) {
            if ([ServersData[@"c"] intValue] == 1) {
