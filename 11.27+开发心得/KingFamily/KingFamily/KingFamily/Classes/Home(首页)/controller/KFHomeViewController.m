...
//    NSLog(@"%@",NSStringFromCGRect(_titleMenu.frame));
...
#pragma mark -------------跳转到搜索控制器，到时候需要跳到自定义的控制器
    titleView.operation = ^{
        ...
        //设置modal的动画效果,iphone上有效
        newNavi.modalTransitionStyle = UIModalTransitionStyleFlipHorizontal;
        
        //这个属性在ipad上面才有效
//        newNavi.modalPresentationStyle = UIModalPresentationCurrentContext;
